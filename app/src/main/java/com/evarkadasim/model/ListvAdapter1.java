...
public class ListvAdapter1 extends CursorAdapter {

    public ListvAdapter1(Context context, Cursor cursor, int flag) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        bilgi.setText(kullanici_adi + " " + il + " Ev Arkadaşı Arıyor");
